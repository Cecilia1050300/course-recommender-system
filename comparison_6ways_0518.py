...
# 💡【優化】放寬篩選：把 MIN_COUNT 設為 0，確保保留所有課程，拯救 Item 系列
MIN_COUNT = 0 
...
# ==========================================
# 7. 【🔥 全新功能】自動過濾並匯出「各方法最佳 K 值與最優誤差」的黃金總表
# ==========================================
print("✨ 正在自動分析並統整各方法的最佳參數解...")
best_param_results = []

# 依據各方法分組，並自動追蹤各組內 RMSE 最低、表現最好的那一橫列 (Row)
...
print("="*65)
print("📊 各方法最佳 K 值與最優誤差統整表 (Best Parameters Summary)")
print("="*65)
